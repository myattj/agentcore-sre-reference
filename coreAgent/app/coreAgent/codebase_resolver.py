...
def _bindings_block(
    ...
    guidance = (
        ...
        "**Don't announce repo defaults.** Never say things like "
        "'noting X as the default for this channel' or 'I'll use X "
        "going forward.' Just use the repo — the user doesn't need "
        "a meta-commentary about your selection process.\n\n"
